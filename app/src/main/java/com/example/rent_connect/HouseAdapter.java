...
public class HouseAdapter extends RecyclerView.Adapter<HouseAdapter.HouseViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HouseViewHolder holder, int position) {
        ...
        holder.priceTextView.setText("BND $" + house.getPrice()); // ✅ SHOW PRICE
        ...
        holder.seeMoreButton.setOnClickListener(v -> {
            ...
            if (house.getDetailImages() != null) {
                intent.putStringArrayListExtra("detailImages", new ArrayList<>(house.getDetailImages()));
            }
    ...
    public static class HouseViewHolder extends RecyclerView.ViewHolder {
        ...
        public HouseViewHolder(@NonNull View itemView) {
            ...
            priceTextView = itemView.findViewById(R.id.price); // ✅ NEW
